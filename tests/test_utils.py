...
from tests._IsmrmrdTestData import IsmrmrdTestData
...
def ismrmrd_test_data_cartesian(tmp_path_factory):
    ...
    ismrmrd_filename = tmp_path_factory.mktemp('raw2ismrmrd') / 'ismrmrd_cart.mrd'
...
def ismrmrd_test_data_radial(tmp_path_factory):
    ...
    ismrmrd_filename = tmp_path_factory.mktemp('raw2ismrmrd') / 'ismrmrd_radial.mrd'
